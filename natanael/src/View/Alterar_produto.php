        ...
        <form action="/cliente/editar/{<?= $params[1] ?>}" method="post">
            <div class="row">
                ...
                <div class="col-5">
                    ...
                    <input type="text" class="form-control" name="email" id="email" value="<?= $resultado['descricao'] ?>" />
                </div>
                <div class="col-2">
                    <label for="idade" class="label-control">
                        Informe o valor:
                    </label>
                    <input type="number" class="form-control" name="idade" id="idade" value="<?= $resultado['valor'] ?>" />
                </div>
            </div>
            <div class="row">
                <div class="col mt-5">
